...
return [
    ...
    */
    ...
    | especificar una línea de idioma personalizada para una regla de atributo dada.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de idioma se utilizan para reemplazar nuestro marcador de posición
    | de atributo por algo más amigable para el lector, como "Dirección de correo electrónico" en lugar
